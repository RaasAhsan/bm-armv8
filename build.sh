...
ld -nostdlib -T linker.ld out/boot.o out/vector.o out/kernel.o out/uart.o out/gic.o out/scheduler.o out/process.o out/syscall.o out/stdlib.o target/aarch64-unknown-none/release/libkernel.a -o out/kernel.elf && \
