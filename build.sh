...
gcc -Iinclude -ffreestanding -c process.c -o process.o && \
ld -nostdlib -T linker.ld boot.o vector.o kernel.o uart.o gic.o scheduler.o syscall.o process.o target/aarch64-unknown-none/release/libkernel.a -o kernel.elf && \
